...
void show_help(){
    ...
    If bpc are required but a size of the box is not provided with the -s argument the program will compute the size of the box based
    on the maximum value of the position of all the points. This may lead to non consistent results \n \n \n"
    << std::endl;

    std::cout << "<calc_type> options: \n \n
    ...
    -s size_box:           (optional) size_box must be a real number which specifies the size of the box containing the the points. \n
