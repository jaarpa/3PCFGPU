...
int main(int argc, char **argv){
    ...
    */
    ...
    //Launch the kernels
    cout << "ddd kernel dimensions: "<<blocks_D<<", "<<threads_perblock_dim<<endl;
    ...
    make_histoXY<<<gridDR,threads_perblock_DR,bn*sizeof(double),streamDR>>>(d_DR, d_ordered_pointsD_DR, dnodeD_DR, nonzero_Dnodes, d_ordered_pointsR_DR, dnodeR_DR, nonzero_Rnodes, bn, dmax, d_max_node, size_box, size_node);
