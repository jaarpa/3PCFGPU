...
int main(int argc, char **argv){
    ...
    */
    ...
    //make_histoXXX<<<gridRRR,threads_perblock,bn*bn*bn*sizeof(double),streamRRR>>>(d_RRR, d_ordered_pointsR_RRR, dnodeR_RRR, nonzero_Rnodes, bn, dmax, d_max_node);
    //make_histoXXY<<<gridDRR,threads_perblock,bn*bn*bn*sizeof(double),streamDRR>>>(d_DRR, d_ordered_pointsR_DRR, dnodeR_DRR, nonzero_Rnodes, d_ordered_pointsD_DRR, dnodeD_DRR, nonzero_Dnodes, bn, dmax, d_max_node);
    //make_histoXXY<<<gridDDR,threads_perblock,bn*bn*bn*sizeof(double),streamDDR>>>(d_DDR, d_ordered_pointsD_DDR, dnodeD_DDR, nonzero_Dnodes, d_ordered_pointsR_DDR, dnodeR_DDR, nonzero_Rnodes, bn, dmax, d_max_node);
