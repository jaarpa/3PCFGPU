...
int main(int argc, char **argv){
    ...
    */
    ...
    cout << "Last ordered D point " << h_ordered_pointsD_s[10000].x << endl;
    cout << "Last ordered R point " << h_ordered_pointsR_s[10000].x << endl;
    ...
    cout << "FreeD the host  D flattened nodes" << endl;
    delete[] hnodeR_s;
